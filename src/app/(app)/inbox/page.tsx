...
export default async function InboxPage({
  ...
  return (
    <PageShell className="flex gap-6">
      ...
      <div className="flex-1 space-y-4">
        ...
        <PageSection>
          ...
          <div className="overflow-x-auto">
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <Link
                        href={`/inbox/${item.id}`}
                        className="font-medium text-slate-900 transition-colors hover:text-brand-600 dark:text-slate-100"
                      >
            ...
            {/* Pagination */}
            {totalPages > 1 && (
              <div className="flex items-center justify-between border-t border-slate-200 bg-slate-50/80 px-4 py-3 text-sm dark:border-slate-700 dark:bg-slate-800/50">
